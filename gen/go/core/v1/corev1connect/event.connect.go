...
const (
	...
	EventServiceName = "core.v1.EventService"
)
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_core_v1_event_proto.Services().ByName("EventService").Methods()
...
// Subscribe calls core.v1.EventService.Subscribe.
...
func (UnimplementedEventServiceHandler) Append(context.Context, *connect.Request[v1.AppendRequest]) (*connect.Response[v1.AppendResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("core.v1.EventService.Append is not implemented"))
}
