...
const (
	...
	EventServiceName = "ultra.v1.EventService"
)
...
const (
	...
	EventServiceAppendProcedure = "/ultra.v1.EventService/Append"
	// EventServiceSubscribeProcedure is the fully-qualified name of the EventService's Subscribe RPC.
	EventServiceSubscribeProcedure = "/ultra.v1.EventService/Subscribe"
)

// EventServiceClient is a client for the ultra.v1.EventService service.
...
// NewEventServiceClient constructs a client for the ultra.v1.EventService service. By default, it
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_ultra_v1_event_proto.Services().ByName("EventService").Methods()
...
// Append calls ultra.v1.EventService.Append.
func (c *eventServiceClient) Append(ctx context.Context, req *connect.Request[v1.AppendRequest]) (*connect.Response[v1.AppendResponse], error) {
	return c.append.CallUnary(ctx, req)
}

// Subscribe calls ultra.v1.EventService.Subscribe.
...
// EventServiceHandler is an implementation of the ultra.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/ultra.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) Append(context.Context, *connect.Request[v1.AppendRequest]) (*connect.Response[v1.AppendResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ultra.v1.EventService.Append is not implemented"))
}
...
func (UnimplementedEventServiceHandler) Subscribe(context.Context, *connect.Request[v1.SubscribeRequest], *connect.ServerStream[v1.SubscribeResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("ultra.v1.EventService.Subscribe is not implemented"))
}
