...
| A7.5 accepted any terminal run state and never asserted a typed tool failure. | The test now requires an error-flagged tool result naming the lost environment. |
